	...
	return (
		<AdminLayout>
			...
			<div className="w-full flex flex-col gap-3 border border-gray-100 p-4 rounded overflow-y-scroll">
				...
				<Link href="/admin/laboratorios/1">
				...
				<Link href="/admin/laboratorios/2">
				...
				<Link href="/admin/laboratorios/3">
				...
				<Link href="/admin/laboratorios/4">
				...
				<Link href="/admin/laboratorios/5">
